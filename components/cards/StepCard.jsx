...
export default function StepCard(props) {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="text-[20px] font-iranBold tracking-[0px] -mb-2 text-[#212529] opacity-100 self-end">
        {title}
      </div>
      ...
      <div className="text-[12px] font-iranBold whitespace-nowrap tracking-[0px]  text-[#70757B]">
        {subTitle}
      </div>
    </div>
  );
